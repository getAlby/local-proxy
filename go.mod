...
require (
	github.com/wailsapp/wails/v2 v2.0.0-beta.21.0.20211203180136-b7a4aba5f3e8
...
// replace github.com/wailsapp/wails/v2 v2.0.0-beta.21 => /Users/bumi/src/go/pkg/mod/github.com/wailsapp/wails/v2@v2.0.0-beta.21
